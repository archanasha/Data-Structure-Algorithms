...
console.log("breadthFirstSearch:: ", binaryTree.breadthFirstSearch(9));
console.log("breadthFirstSearchRecurrsive:: ",
    binaryTree.breadthFirstSearchRecurrsive([binaryTree], []));
